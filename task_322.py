...
class DataSet:
    ...
    def count_area_data(self, area_to_sum: dict, area_to_count: dict) -> None:
        self.area_to_salary, self.area_to_piece = DataSet.get_area_to_salary_and_piece(area_to_sum, area_to_count)
class Report:
    ...
    def generate_pdf(self, file_name: str):
        ...
        config = pdfkit.configuration(wkhtmltopdf=r"D:/pythonSecondVar/wkhtmltopdf.exe")
